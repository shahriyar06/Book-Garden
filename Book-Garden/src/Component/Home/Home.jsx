            ...
            <div className="mb-16">
                <div className=" bg-[#c9c6c64f] rounded-3xl py-8">
                    <div className="hero-content flex-col lg:flex-row-reverse lg:w-10/12 mx-auto">
                        ...
                        <div>
                            <h1 className="text-6xl font-bold mb-10">Books to <span className="text-violet-400">freshen up</span> your bookshelf ..</h1>
                            <button className="btn bg-[#23BE0A] border-[#23BE0A] text-base text-[#FFFFFF] hover:bg-[#2cd212]">View The List</button>
                        </div>
                    </div>
                </div>
            </div>
